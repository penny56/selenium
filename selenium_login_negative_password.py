...
class LoginPage:
    ...
    neg_password = 'incorrectPassword '
...
def login_test():
    ...
    try:
        ...
        print("开始登录流程...")
        login_page.login(login_page.username, login_page.neg_password)


        WebDriverWait(driver, 10).until(
            EC.text_to_be_present_in_element((By.TAG_NAME, 'body'), 'Your password is invalid!')
        )
        print('页面包含预期文本！')
